...
def start_test(input_test,T):
    ...
    for f in files:
        ...
        if (f.split("/")[-1] == input_test):
            ...
            print "\tdetected as - ", genders[winner], "\n\tscores:Neutral ", log_likelihood[0], ",Fear ", \
            log_likelihood[
                1], ",Angry ", log_likelihood[2], ",Disgust ", log_likelihood[3], ",PleasantSurprise ", log_likelihood[
                4], ",Sad ", log_likelihood[5], ",Happy ", log_likelihood[6], "\n"
            T.insert(END, input_test + ":\n" + "Detected as - " + genders[winner] + "\n")
